...
# Updated target URL (Note: ensure this endpoint actually returns an M3U format layout)
UPSTREAM_URL = "https://thedaddy.to/"
...
def fetch_playlist():
    # Adding a standard User-Agent header as websites like thedaddy.to block default Python requests
    headers = {
...
if __name__ == "__main__":
    try:
        ...
        print("Note: If the target URL returns HTML instead of M3U data, parsing will fail.")
